...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, user: $user, onboardingComplete: $onboardingComplete, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, user, onboardingComplete, errorMessage);
